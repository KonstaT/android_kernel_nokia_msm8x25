...
static int mipi_video_hx8392a_720p_pt_init(void)
{
	int ret;

	if (msm_fb_detect_client("mipi_video_hx8392a_720p"))
		return 0;
	...
	pinfo.mipi.t_clk_post = 0xa4;
	pinfo.mipi.t_clk_pre = 0xb;
	...
	ret = mipi_hx8392a_device_register(&pinfo, MIPI_DSI_PRIM,
...
module_init(mipi_video_hx8392a_720p_pt_init);
