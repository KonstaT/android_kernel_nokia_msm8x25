...
DEFINE_SEMAPHORE(otm9608a_yassy_sem);
...
/* DSI_BIT_CLK at 500MHz, 2 lane, RGB888 */
		...
		/* timing   */
		{0x8b, 0x33, 0x14, 0x0, 0x45, 0x4e, 0x18,
		0x36, 0x18, 0x03, 0x04},
		/* phy ctrl */
		{0x7f, 0x00, 0x00, 0x00},
		/* strength */
		...
		0x00, 0x07, 0x03,
		0x05, 0x14, 0x03, 0x0, 0x0, 0x00, 0x20, 0x00, 0x02, 0x0},
};
...
static void otm9608a_backlight_set(int level)
{
	...
	ret = pmapp_disp_backlight_set_brightness(level*160/255);
	if (ret)
