...
static struct mipi_dsi_phy_ctrl dsi_video_mode_phy_db = {
	...
	{0x13, 0x01, 0x01, 0x00},
	/* timing   */
        {0x8B, 0x33, 0x14, 0x00, 0x45, 0x4E, 0x18, 0x36,
        0x18, 0x0F, 0x04},
	/* phy ctrl */
	{0x7f, 0x00, 0x00, 0x00},
	/* strength */
	{0xbb, 0x02, 0x06, 0x00},
	/* pll control */
        {0x00, 0xF6, 0x30, 0xD2, 0x00, 0x40, 0x37, 0x62,
        0x00, 0x07, 0x03,
        0x05, 0x14, 0x03, 0x0, 0x0, 0x0, 0x20, 0x0, 0x02, 0x0},
};

static int mipi_video_otm9605a_qhd_pt_init(void)
{
	int ret;

	if (msm_fb_detect_client("mipi_video_otm9605a_qhd"))
		return 0;
	...
	ret = mipi_otm9605a_device_register(&pinfo, MIPI_DSI_PRIM,
...
module_init(mipi_video_otm9605a_qhd_pt_init);
